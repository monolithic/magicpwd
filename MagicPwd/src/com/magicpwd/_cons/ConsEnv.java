...
//    String ICON_NONE = "default";// 空白
//    String ICON_SOFT_HELP = ICON_NONE + 1;// 帮助
//    String ICON_SOFT_EXIT = ICON_SOFT_HELP + 1;// 退出
//    String ICON_SOFT_UCFG = ICON_SOFT_EXIT + 1;// 设定
//    String ICON_KIND_CLPS = ICON_SOFT_UCFG + 1;// 折叠
//    String ICON_KIND_XPND = ICON_KIND_CLPS + 1;// 展开
//    String ICON_KEYS_APND = ICON_KIND_XPND + 1;// 新建
//    String ICON_KEYS_SAVE = ICON_KEYS_APND + 1;// 保存
//    String ICON_KEYS_DELT = ICON_KEYS_SAVE + 1;// 删除
//    String ICON_KEYS_MOD0 = ICON_KEYS_DELT + 1;
//    String ICON_KEYS_MOD1 = ICON_KEYS_MOD0 + 1;
//    String ICON_KEYS_MOD2 = ICON_KEYS_MOD1 + 1;
//    String ICON_KEYS_MOD3 = ICON_KEYS_MOD2 + 1;
//    String ICON_KEYS_MOD4 = ICON_KEYS_MOD3 + 1;
//    String ICON_KEYS_MOD5 = ICON_KEYS_MOD4 + 1;
//    String ICON_KEYS_MOD6 = ICON_KEYS_MOD5 + 1;
//    String ICON_KEYS_MOD7 = ICON_KEYS_MOD6 + 1;
//    String ICON_KEYS_MOD8 = ICON_KEYS_MOD7 + 1;
//    String ICON_KEYS_MOD9 = ICON_KEYS_MOD8 + 1;
//    String ICON_KEYS_NTN2 = ICON_KEYS_MOD9 + 1;
//    String ICON_KEYS_NTN1 = ICON_KEYS_NTN2 + 1;
//    String ICON_KEYS_NOTE = ICON_KEYS_NTN1 + 1;
//    String ICON_KEYS_NTP1 = ICON_KEYS_NOTE + 1;
//    String ICON_KEYS_NTP2 = ICON_KEYS_NTP1 + 1;
//    String ICON_ITEM_PREV = ICON_KEYS_NTP2 + 1;// 向上
//    String ICON_ITEM_NEXT = ICON_ITEM_PREV + 1;// 向下
//    String ICON_ITEM_LEFT = ICON_ITEM_NEXT + 1;// 向左
//    String ICON_ITEM_RGHT = ICON_ITEM_LEFT + 1;// 向右
//    String ICON_TOOL_HIST = ICON_ITEM_RGHT + 1;// 历史
//    String ICON_TOOL_TAIL = ICON_TOOL_HIST + 1;// 分离
//    String ICON_PROP_COPY = ICON_TOOL_TAIL + 1;// 复制
//    String ICON_PROP_UPDT = ICON_PROP_COPY + 1;// 更新
//    String ICON_PROP_DELT = ICON_PROP_UPDT + 1;// 删除
//    String ICON_GUID_MAIL = ICON_PROP_DELT + 1;// 邮件
//    String ICON_GUID_CARD = ICON_GUID_MAIL + 1;// 卡片
//    String ICON_HINT_DATE = ICON_GUID_CARD + 1;// 提醒
//    String ICON_PWDS_HIDE = ICON_HINT_DATE + 1;// 隐藏
//    String ICON_PWDS_VIEW = ICON_PWDS_HIDE + 1;// 显示
//    String ICON_PWDS_GENT = ICON_PWDS_VIEW + 1;// 生成
//    String ICON_PWDS_UCFG = ICON_PWDS_GENT + 1;// 选项
//    String ICON_HIST_PICK = ICON_PWDS_UCFG + 1;// 恢复
//    String ICON_HIST_DROP = ICON_HIST_PICK + 1;// 恢复
//    String ICON_LINK_OPEN = ICON_HIST_DROP + 1;// 链接
//    String ICON_MAIL_OPEN = ICON_LINK_OPEN + 1;// 邮件
//    String ICON_DATE_TIME = ICON_MAIL_OPEN + 1;// 时间
//    String ICON_FILE_OPEN = ICON_DATE_TIME + 1;// 打开
//    String ICON_FILE_PICK = ICON_FILE_OPEN + 1;// 选择
//    String ICON_NOTE_OPEN = ICON_FILE_PICK + 1;// 选择
//    String ICON_NOTE_SRCH = ICON_NOTE_OPEN + 1;// 选择
//    String ICON_MAIL_FILE = ICON_NOTE_SRCH + 1;// 附件
//    String ICON_SIZE = ICON_MAIL_FILE + 1;
