...
public class SeaGlassLookAndFeel extends NimbusLookAndFeel {
    ...
    private void defineButtons(UIDefaults d) {
        ...
        d
            .put(p + "[Default+Focused+Pressed].backgroundPainter", new LazyPainter(c,
        ...
        d.put(p + "[Focused+Pressed+Selected].iconPainter", new LazyPainter(c, CheckBoxPainter.Which.ICON_PRESSED_SELECTED_FOCUSED));
        ...
        d.put(p + "[Focused+Pressed+Selected].iconPainter", new LazyPainter(c, RadioButtonPainter.Which.ICON_PRESSED_SELECTED_FOCUSED));
    ...
    private void defineProgressBars(UIDefaults d) {
        ...
        d.put(p + "[Enabled+Finished].foregroundPainter", new LazyPainter(c, ProgressBarPainter.Which.FOREGROUND_ENABLED_FINISHED));
        ...
        d.put(p + "[Disabled+Finished].foregroundPainter", new LazyPainter(c, ProgressBarPainter.Which.FOREGROUND_DISABLED_FINISHED));
        d.put(p + "[Disabled+Indeterminate].foregroundPainter", new LazyPainter(c,
    ...
    private void defineSliders(UIDefaults d) {
        ...
        d.put(p + "[ArrowShape+Focused+MouseOver].backgroundPainter", new LazyPainter(c,
            SliderThumbPainter.Which.BACKGROUND_FOCUSED_MOUSEOVER_ARROWSHAPE));
        d.put(p + "[ArrowShape+Focused+Pressed].backgroundPainter", new LazyPainter(c,
    ...
    private void defineTabbedPanes(UIDefaults d) {
        ...
        d.put(p + "[Focused+Pressed+Selected].backgroundPainter", new LazyPainter(c,
            TabbedPaneTabPainter.Which.BACKGROUND_PRESSED_SELECTED_FOCUSED));
        d.put(p + "[Disabled].textForeground", d.get("nimbusDisabledText"));
    ...
    /**
     * Returns {@code true} if the <code>LookAndFeel</code> returned {@code
     * RootPaneUI} instances support providing {@code Window} decorations in a
     * {@code JRootPane}.
     * 
     * <p>
     ...
     * 
     * @param state
     *            the SynthContext representing the current state.
     * @param insets
     *            an Insets object to be filled with the painting insets.
     * 
     ...
     *            the component.
     * 
     * @return {@code true} if the component is laid out left-to-right, {@code
     *         false} if right-to-left.
     */
     ...
     * 
     * @return {@code ui} if {@code klass} is an instance of {@code ui}, {@code
     *         null} otherwise.
     */
     ...
     * 
     * @return the {@code BorderLayout} orientation of the toolbar, or {@code
     *         BorderLayout.NORTH} if none can be determined.
     */
     ...
     * shouldUpdateStyleOnAncestorChanged</code>
     * as necessary.
     * 
     * @param event
    ...
    private static final class LazyPainter implements UIDefaults.LazyValue {
         ...
         * 
         * @param className
         *            the painter class to be instantiated in a lazy fashion.
         * @param which
         *            the state for the painter class to paint. This will be an
         *            enum defined in the painter class andspecific to it.
         */
    ...
    private final class LazyStyle {
         ...
         * 
         * @return {@code true} if the component matches the style, {@code
         *         false} otherwise.
         */
