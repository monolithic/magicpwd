...
public class TpltDialog extends ADialog
{
    ...
    public TpltDialog(MexpPtn mexpPtn)
    {
        super(mexpPtn, true);
    ...
    public void initData()
    {
        ...
        for (Tplt tplt : mexpPtn.getUserMdl().getTpltMdl().getAllItems())
        {
            ...
            propList = DBA4000.selectTpltData(tplt.getP30F1103());
    ...
    private void viewData(I1S1 item)
    {
        if (item.getK() == ConsDat.INDX_LIST)
        {
            ...
            java.util.List<I1S2> list = DBA4000.selectListData(currTplt.getP30F1103());
