...
public interface ConsEnv
{
    ...
    int ICON_KEYS_STA0 = ICON_KEYS_SRCH + 1;
    int ICON_KEYS_STA1 = ICON_KEYS_STA0 + 1;
    int ICON_KEYS_STA2 = ICON_KEYS_STA1 + 1;
    int ICON_KEYS_STA3 = ICON_KEYS_STA2 + 1;
    int ICON_KEYS_STA4 = ICON_KEYS_STA3 + 1;
    int ICON_KEYS_STA5 = ICON_KEYS_STA4 + 1;
    int ICON_KEYS_STA6 = ICON_KEYS_STA5 + 1;
    int ICON_KEYS_STA7 = ICON_KEYS_STA6 + 1;
    int ICON_KEYS_STA8 = ICON_KEYS_STA7 + 1;
    int ICON_KEYS_STA9 = ICON_KEYS_STA8 + 1;
    int ICON_ITEM_PREV = ICON_KEYS_STA9 + 1;// 向上
    ...
    int ICON_PWDS_HIDE = ICON_PROP_DELT + 1;// 隐藏
