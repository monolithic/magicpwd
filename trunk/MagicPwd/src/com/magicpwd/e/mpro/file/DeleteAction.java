...
public class DeleteAction extends AMproAction
{
    ...
    public void actionPerformed(java.awt.event.ActionEvent e)
    {
        ...
        if (Lang.showFirm(mproPtn, MproRes.P30F7A0A, "您正在进行的操作是删除记录数据及其所有历史信息，确认继续么？") != javax.swing.JOptionPane.YES_OPTION)
        {
            return;
        }
        if (Lang.showFirm(mproPtn, MproRes.P30F7A0B, "确认一下您操作的正确性，要返回么？") != javax.swing.JOptionPane.NO_OPTION)
        {
            return;
        }
