...
public class MenuPwd extends JPopupMenu
{
    ...
    public void setTplt(Item tplt)
    {
        ...
        String size = tplt.getSpec(Item.PWDS_CHAR_SIZE);
        try
        {
        ...
        String hash = tplt.getSpec(Item.PWDS_CHAR_HASH);
        ...
        mi_UrptMenu.setSelected("1".equals(tpltData.getSpec(Item.PWDS_CHAR_NRPT)));
    }
    ...
    private void mi_SizeMenuActionPerformed(java.awt.event.ActionEvent evt)
    {
        ...
        tpltData.setSpec(Item.PWDS_CHAR_SIZE, t);
    }

    private void mi_SizeMoreActionPerformed(java.awt.event.ActionEvent evt)
    {
        String s = JOptionPane.showInputDialog(MagicPwd.getFrame(), "", tpltData.getSpec(Item.PWDS_CHAR_SIZE));
        if (s == null)
        {
            return;
        }
        ...
        if (s.length() < 1)
        {
            Lang.showMesg(MagicPwd.getFrame(), "", "");
            return;
        }
        ...
        tpltData.setSpec(Item.PWDS_CHAR_SIZE, s);
    }
    ...
    private void mi_CharMenuActionPerformed(java.awt.event.ActionEvent evt)
    {
        ...
        tpltData.setSpec(Item.PWDS_CHAR_HASH, t.substring(0, 8));
    ...
    {
        tpltData.setSpec(Item.PWDS_CHAR_NRPT, mi_UrptMenu.isSelected() ? "1" : "0");
    }
