...
public class DocumentResumableUploadDemo {
   ...
   */
  DocumentResumableUploadDemo(Google docs, PrintStream out) {
    this.docs = docs;
    this.output = out;
  }
  ...
  private boolean executeCommand(BufferedReader reader) throws Exception {
  ...
  public static void main(String[] args) throws Exception {
    ...
    // authenticate
    Google docs = new Google(APPLICATION_NAME);
