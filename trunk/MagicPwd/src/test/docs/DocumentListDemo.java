...
public class DocumentListDemo
{
    ...
    private final String[] COMMAND_HELP_ERROR =
    {
        "unknown command"
    };
    ...
    public DocumentListDemo(PrintStream outputStream, String appName, String authProtocol,
            String authHost, String protocol, String host) throws Exception
    {
        out = outputStream;
        documentList = new Google(appName, authProtocol, authHost, protocol, host);
    }
     ...
     * @throws DocumentListException
     */
    private void executeCreate(String[] args) throws Exception
    {
        if (args.length == 3)
        {
     ...
     * @throws DocumentListException
     */
    private void executeTrash(String[] args) throws Exception
    {
        if (args.length == 3)
        {
     ...
     * @throws DocumentListException
     */
    private void executeDownload(String[] args) throws Exception
    {
        if (args.length == 3)
        {
            ...
            else
            {
                ...
                String requestedFormat = args[2].substring(args[2].lastIndexOf(".") + 1);
     ...
     * @throws DocumentListException
     */
    private void executeList(String[] args) throws Exception
    {
     ...
     * @throws DocumentListException
     */
    private void executeMove(String[] args) throws Exception
    {
        if (args.length == 3)
        {
     ...
     * @throws DocumentListException
     */
    private void executePerms(String[] args) throws Exception
    {
        if (args.length < 3)
        {
     ...
     * @throws DocumentListException
     */
    private void executeRemove(String[] args) throws Exception
    {
        if (args.length == 3)
        {
     ...
     * @throws DocumentListException
     */
    private void executeSearch(String[] args) throws Exception
    {
        if (args.length == 2)
        {
     ...
     * @throws DocumentListException
     */
    private void executeAdvancedSearch(String[] args) throws Exception
    {
        if (args.length <= 1)
        {
        ...
        {
            searchParameters.put(args[i].substring(0, args[i].indexOf("=")), args[i].substring(args[i].indexOf("=") + 1));
        }
     ...
     * @throws DocumentListException
     */
    private void executeUpload(String[] args) throws Exception
    {
        if (args.length == 3)
        {
            DocumentListEntry entry = documentList.upload(args[1], args[2], "application/zip");
            printDocumentEntry(entry);
        }
        else
        {
     ...
     * @throws DocumentListException
     */
    private void executeRevisions(String[] args) throws Exception
    {
        if (args.length == 2)
        {
            ...
            throws Exception
    {
        args = new String[]
                {
                    "--username", "Amon.RG@gmail.com", "--password", "A_v`OVU5"
                };
        ...
        {
            authProtocol = Google.DEFAULT_AUTH_PROTOCOL;
        }

        if (authHost == null)
        {
            authHost = Google.DEFAULT_AUTH_HOST;
        }

        if (protocol == null)
        {
            protocol = Google.DEFAULT_PROTOCOL;
        }

        if (host == null)
        {
            host = Google.DEFAULT_HOST;
        }
